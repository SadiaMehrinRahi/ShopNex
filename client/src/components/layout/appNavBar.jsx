...
import logo from "../../assets/images/ShopNex-logo.svg"
...
const AppNavBar = () => {
    ...
    return (
        <>
            <div className="container-fluid text-white p-0 bg-success">
                <div className="container">
                    <div className="row justify-content-around">
                        <div className="col-md-6">
                            <span>
                                <span className="f-12">
                                    <i className="bi bi-envelope"></i> Support@ShopNex.com
                                </span>
                                <span className="f-12 mx-2">
                                    <i className="bi bi-envelope"></i> 01729000000
                                </span>
                            </span>
                        </div>
                        <div className="col-md-6">
            ...
            <nav className="navbar sticky-top shadow-sm bg-white navbar-expand-lg navbar-light m-0 py-0">
                <div className="container ">
                    <Link className="navbar-brand" to="/">
                        <img className="img-fluid" src={logo} alt="" width="190px" />
                    </Link>
                    ...
                    <div className="d-lg-flex">
                        <div className="input-group">
                            ...
                            <Link to={SearchKeyword.length>0?`/by-keyword/${SearchKeyword}`:`/`} className="btn btn-outline-dark" type="submit">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ width: 18, height: 14 }}>
